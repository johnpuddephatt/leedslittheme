<div class="group flex items-center gap-1">
  <div class="relative overflow-hidden bg-pink px-5 py-1.5">
    <svg {{ $attributes->class('h-7 w-auto flex-none  relative z-10 ') }} xmlns="http://www.w3.org/2000/svg"
      ...
      <path fill="#fff" d="M.38 2.46 2.94 4.4 9.94 2.65 7.58.45.38 2.46z" />
      <path fill="#fff" d="M3.01 4.42 10.68 2.57 10.77 13.63 3.03 15.54 3.01 4.42z" />
      <path fill="none" stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width=".34"
        d="M8.32.17.17 2.4.17 13.95 2.78 15.66 10.77 13.63 10.77 2.47 2.83 4.42.17 2.4" />
      <path d="M.27 2.7 2.72 4.49 2.69 15.51.17 13.84.27 2.7z" />
    </svg>
